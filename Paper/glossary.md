...
7. Action space <br/>
    The set ![img](https://latex.codecogs.com/svg.latex?U%28X_a%3B%20x%29) represents the set of feasible actions, given agent a’s local state space ![img](https://latex.codecogs.com/svg.latex?X_a), and the global state ![img](https://latex.codecogs.com/svg.latex?%24x%24).
