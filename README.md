...
Alpha bonds are generated by risk-adjusted bonding curves, which are dynamic curves that adapt with a prediction mechanism coefficient $alpha$. The diagram below demonstrates how alpha updates through agent attestations.

![img](https://i.imgur.com/AnxLa0x.png)

## Alpha Bond Details

Read more about our [methodology & use case](Paper/0_ProblemStatementandMethodology.md), the [lifecycle stages of an Alpha Bond](Paper/2_BondLifecyclePhases.md) or [what agent roles are involved](Paper/1_EcosystemRoles.md) in our Phase I documentation. 
...
![img](https://i.imgur.com/1HSctzL.png)
<br>
